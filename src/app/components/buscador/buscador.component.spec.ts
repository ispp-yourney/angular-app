...
describe('Buscador', () => {
  ...
  it('should use loadItineraries function', fakeAsync(() => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
  ...
  it('should use loadItineraries function with 2 pages results', fakeAsync(() => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
  ...
  it('should use loadItineraries function with 3 pages results', () => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
  ...
  it('should use loadItineraries function with 3 pages results and prueba=1 and currentPage = initialPages[0]', () => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
    spyOn(buscadorService,'postFilter').and.returnValue(of(landmarkPage3))
    component.prueba=1
  ...
  it('should use loadItineraries function with 3 pages results and prueba=1 and currentPage = initialPages[0] and initialPages[length] big', () => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
    spyOn(buscadorService,'postFilter').and.returnValue(of(landmarkPage3))
    component.prueba=1
  ...
  it('should use loadItineraries function with 2 pages results and currentPage != initialPages[0] ', () => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
    spyOn(buscadorService,'postFilter').and.returnValue(of(landmarkPage2))
    component.prueba=1
  ...
  it('should use loadItineraries function with 2 pages results and currentPage != initialPages[0] and initialPages[0] + 1 < totalPages', () => { 
    spyOn(buscadorService,'getAllCountry').and.returnValue(of(countries))
    spyOn(buscadorService,'getCityByCountry').and.returnValue(of(['Sevilla']))
    spyOn(buscadorService,'postFilter').and.returnValue(of(landmarkPage2))
    component.prueba=1
  ...
  it('should fail to use loadItineraries function', () => { 
...
it('should use countStars and countNoStars functions ', fakeAsync(() => {
  ...
  fixture.detectChanges();
  expect(component.ngOnInit).toBeTruthy()
  component.countStars(0)
  component.countNoStars(0)
}));
